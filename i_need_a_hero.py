...
def compare_teams(new_team, old_team):
    ...
    return team_diff_num, fancify_hero_list(list(team_diff_list))
    ...
    if continue_ or dev:
        ...
        if total_conf_average > process_threshold:
            ...
            print("({} changed from previous analysis{}) {}"
                  .format(diff_from_previous_enemy[0], diff_from_previous_enemy[1],
            ...
            print("({} changed from previous analysis{}) {}"
                  .format(diff_from_previous_allied[0], diff_from_previous_allied[1],
